...
public class FileDoc_20915795_CaicesLima extends File_20915795_CaicesLima implements IFile_20915795_CaicesLima {
    /**
     ...
     * @author Byron Caices
     */
    public FileDoc_20915795_CaicesLima(String name, FileSystem_20915795_CaicesLima fl){
        name.toLowerCase();
    ...
    public FileDoc_20915795_CaicesLima(){
        //name.toLowerCase();
        this.itemName ="";
     ...
     */
    @Override
    public FileDoc_20915795_CaicesLima itemClone(){

        FileDoc_20915795_CaicesLima newFile = new FileDoc_20915795_CaicesLima();
