...
public class FileCode_20915795_CaicesLima extends File_20915795_CaicesLima implements IFile_20915795_CaicesLima {
    /**
     ...
     * @author Byron Caices
     */
    public FileCode_20915795_CaicesLima(String name, FileSystem_20915795_CaicesLima fl){
        name.toLowerCase();
    ...
    public FileCode_20915795_CaicesLima(){
        //name.toLowerCase();
        this.itemName ="";
     ...
     */
    @Override
    public FileCode_20915795_CaicesLima itemClone(){

        FileCode_20915795_CaicesLima newFile = new FileCode_20915795_CaicesLima();
